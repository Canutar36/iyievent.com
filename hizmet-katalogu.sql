...
-- RLS politikaları zaten mevcut, atlanıyor.
...
('Palyaço & Eğlence Paketi', 'cocuk', 'Palyaço, yüz boyama, balon heykeli ve oyunlar.', 'sabit', 8000, 0, true, 2),
...
('Su Parkı & Yaz Partisi', 'cocuk', 'Su oyunları, şişme havuz, su tabancası ve soğuk ikramlar.', 'kisi_basi', 300, 15, true, 5),
...
('Pamuk Şeker Standı', 'İkram', 'Renkli pamuk şekeri yapımı ve servisi.', 'sabit', 6000, true, 3),
...
('Çikolata Şelalesi', 'İkram', 'Çikolata şelalesi, meyve ve kurabiye dalama.', 'sabit', 10000, true, 7),
...
('Balon Gösterisi', 'Eğlence', 'Büyük balon gösterisi, çocuklara yönelik.', 'sabit', 8000, true, 7),
...
('Konfeti Makinesi', 'Eğlence', 'Konfeti ve streamer efekti makinesi.', 'sabit', 4000, true, 11),
...
('Müzik Grubu / Band', 'Eğlence', 'Canlı müzik grubu, rock/pop/jazz repertuvarı.', 'sabit', 45000, true, 14),
...
('Davetiye Tasarımı & Baskı', 'Prodüksiyon', 'Özel tasarım davetiye, dijital veya basılı.', 'adet', 50, true, 6),
...
('Gelin Yolu', 'Dekor', 'Gelin yolu için çiçek ve kumaş dekorasyonu.', 'sabit', 12000, true, 5),
...
('Evcil Hayvan Bakıcısı', 'Lojistik', 'Evcil hayvan bakımı ve koruma.', 'sabit', 4000, true, 8),
...
-- TAMAM
-- ============================================================
DO $$ BEGIN RAISE NOTICE '=== TÜM HİZMETLER VE EKSTRALAR BAŞARIYLA EKLENDİ ==='; END $$;
